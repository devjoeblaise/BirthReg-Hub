...
import {AiOutlineUser, AiOutlineHome,AiOutlineClockCircle,} from "react-icons/ai";
    ...
    <div className="min-h-[calc(100vh-80px)] bg-linear-to-br from-purple-900 via-black to-blue-900 text-white pt-10 pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.h1
          ...
          className="text-4xl font-bold text-center mb-8 tracking-wide drop-shadow-[0_0_15px_rgba(255,255,255,0.5)] text-white"
        >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* PLACE OF BIRTH */}
            <div>
              <label className="block text-sm text-gray-200 mb-2">Place of Birth</label>
              <div className="flex items-center bg-white/10 p-3 rounded-lg">
            ...
            {/* TIME OF BIRTH */}
            <div>
              <label className="block text-sm text-gray-200 mb-2">Time of Birth</label>
              <div className="flex items-center bg-white/10 p-3 rounded-lg">
            ...
            {/* FATHER NAME */}
            <div>
              <label className="block text-sm text-gray-200 mb-2">Father's Name</label>
              <input
            ...
            {/* MOTHER NAME */}
            <div>
              <label className="block text-sm text-gray-200 mb-2">Mother's Name</label>
              <input
                className="w-full p-3 bg-white/10 rounded-lg text-white outline-none"
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-end items-center">
            ...
            >
              {loading ? "Submitting..." : editData ? "Update Record" : "Save Record"}
            </button>
          </div>
        </form>
